...
* Visualisasi peta satelit interaktif menggunakan Folium
* Sistem routing nyata menggunakan OSRM API
* Pilihan mode transportasi (jalan kaki, sepeda, motor, mobil)
...
```bash
pip install streamlit geopy numpy scikit-learn folium streamlit-folium requests
```
